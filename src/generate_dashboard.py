...
<head>
  ...
  <style>
    ...
    .dc-polar-wrap {{ max-width: 640px; width: 100%; margin: 0 auto 10px; }}
    ...
    @media (max-width: 720px) {{
      .dc-polar-canvas-wrap {{ height: clamp(200px, 30vh, 300px); }}
...
function renderDrinkCosts() {{
  ...
  h.push('<div class="dc-sticky-header">'
    ...
    + '<p class="dc-polar-caption">👆 คลิกกลีบเพื่อเลือกช่องทาง</p>'
    + '</div>'
